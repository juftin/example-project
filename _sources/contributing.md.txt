...
example-project uses [Poetry] to  manage its Python environment.
...
example-project makes use of a couple tools to help with contributing via
...
- `example-project`'s instance of `pre-commit` uses tools like [black](https://github.com/psf/black)
  and
...
- `example-project`'s instance of `tox` runs Python unit tests, and uses tools like
